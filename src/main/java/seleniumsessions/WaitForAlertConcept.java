...
public class WaitForAlertConcept {
	...
	public static void main(String[] args) {
		...
		// driver.switchTo().alert();  //NoAlertPresentException: no such alert
		                              // no need to write driver.switchTo(), below is the correct format.
	...
	public static String doGetAlertText(int timeOut) { //go to the specific alert and capture the text
