...
//** Interview Question : to capture the text only from 1 column or from "Contact" column or any other column:
		//th[text()='Contact']/parent::tr//following-sibling::tr/td[2]
		//th[text()='Contact']/parent::tr//following-sibling::tr/td[1]
