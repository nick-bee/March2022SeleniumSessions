...
public class GoogleSearchHandle {
		...
		public static void selectGoogleSuggestion(By locator, String searchKey, String suggValue) throws InterruptedException {
			...
			public static List<String> getGoogleSuggList(By locator, String searchKey) throws InterruptedException {
				driver.findElement(By.name("q")).sendKeys(searchKey);
				Thread.sleep(3000);
				List<WebElement> suggList = driver.findElements(locator); //capture the List of WebElement
